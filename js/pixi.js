...
function onHPDown(){
	...
	creatureInfo.info_stat_text.forEach((text,textIndex) =>{
		text.style.fontSize = skillNameFontSize;
		if(textIndex < 3){
			text.x = ((textIndex%3)+1) * app.screen.width/10 + app.screen.width/30;
		}else if(textIndex%3 != 0){
			text.x = (textIndex%3) * app.screen.width/10 + app.screen.width/30;
			text.y = Math.floor(textIndex/3) * app.screen.height/12;
		}else{
			text.x = (textIndex%3) * app.screen.width/10 + app.screen.width/15;
			text.y = Math.floor(textIndex/3) * app.screen.height/12;
		}
	});
	...
	creatureInfo.info_stat_text[8].text = this.object.statMod[1];
	...
	creatureInfo.info_stat_text[11].text = this.object.statMod[2];
	...
	creatureInfo.info_stat_text[14].text = this.object.statMod[3];
	...
	creatureInfo.info_stat_text[17].text = this.object.statMod[4];
	...
	creatureInfo.info_stat_text[20].text = this.object.statMod[5];
	...
	creatureInfo.info_stat_text[23].text = this.object.statMod[6];
	// if(skillIndex%2 == 0){
	// 	textSkill.x = 0;
