...
//     		armatureHero.animation.play('idle');
	...
	pAtkTween.fromTo(sprite_p_attack, anim2, {x:600, y:0}, {ease:"custom", x: 600, y:0}, anim1);
	pAtkTween.fromTo(sprite_p_fxTop, anim2, {x:900, y:0}, {ease:"custom", x: 900, y:0, onComplete: function(){
		sprite_p_fxBack.visible = false;
		sprite_p_attack.visible = false;
		sprite_p_fxTop.visible = false;
