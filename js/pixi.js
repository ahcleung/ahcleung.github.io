...
//     		armatureHero.animation.play('idle');
	...
	pAtkTween.fromTo(sprite_p_fxBack, anim2, {x:-400, y:0}, {ease:"custom", x: -350, y:0});
	pAtkTween.fromTo(sprite_p_attack, anim2, {x:200, y:0}, {ease:"custom", x: 300, y:0}, anim1);
	pAtkTween.fromTo(sprite_p_fxTop, anim2, {x:750, y:0}, {ease:"custom", x: 1000, y:0, onComplete: function(){
		sprite_p_fxBack.visible = false;
		sprite_p_attack.visible = false;
		sprite_p_fxTop.visible = false;
