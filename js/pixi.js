...
//     		armatureHero.animation.play('idle');
	...
	pAtkTween.fromTo(sprite_p_fxBack, anim2, {x:200, y:-150}, {ease:"custom", x:200, y:-150});
	pAtkTween.fromTo(sprite_p_attack, anim2, {x:450, y:-75}, {ease:"custom", x:450, y:-75}, anim1);
