...
//     		armatureHero.animation.play('idle');
	...
	pAtkTween.fromTo(sprite_p_fxBack, anim2, {x:0, y:0}, {ease:"custom", x: 50, y:0});
	pAtkTween.fromTo(sprite_p_attack, anim2, {x:500, y:0}, {ease:"custom", x: 650, y:0}, anim1);
	pAtkTween.fromTo(sprite_p_fxTop, anim2, {x:1100, y:0}, {ease:"custom", x: 1400, y:0, onComplete: function(){
		sprite_p_fxBack.visible = false;
		sprite_p_attack.visible = false;
		sprite_p_fxTop.visible = false;
