...
// 	});
	...
	var info_skill_acc1 = new Text("Accuracy:", {fontFamily : styleFontFamily, fontSize: 28, fill : 0xfefefe, fontWeight: 700, align : 'left'});
...
function onHPDown(){
	...
	creatureInfo.info_main_text[10].text = "It's dominant hand is encrusted with a rock-like formation that it uses as a shield and a weapon. The rock is bejeweled with spiritual gems.";
	...
	creatureInfo.info_main_expBar[0].height = app.screen.height/51.6;
