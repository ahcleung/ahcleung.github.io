...
function resizeInfo(){
	...
	creatureInfo.info_stat_text.forEach((text,textIndex) =>{
		...
		if(textIndex < 3){
			...
			text.x = (textIndex%3) * app.screen.width/11 + app.screen.width/50;
...
function onHPDown(){
	...
	creatureInfo.info_stat_text.forEach((text,textIndex) =>{
		text.style.fontSize = skillNameFontSize;
		if(textIndex < 2){
			text.x = ((textIndex%3)+1) * app.screen.width/11.5 + app.screen.width/50;
		}else if(textIndex == 2){
			text.x = ((textIndex%3)+1) * app.screen.width/11 + app.screen.width/50;
		}else if(textIndex%3 != 0){
			text.x = (textIndex%3) * app.screen.width/11.5 + app.screen.width/50;
			text.y = Math.floor(textIndex/3) * app.screen.height/12;
		}else{
			text.x = app.screen.width/15;
			text.y = Math.floor(textIndex/3) * app.screen.height/12;
