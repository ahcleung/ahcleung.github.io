...
//     		armatureHero.animation.play('idle');
	...
	pAtkTween.fromTo(sprite_p_fxBack, anim2, {x:225, y:-150}, {ease:"custom", x:250, y:-150});
	pAtkTween.fromTo(sprite_p_attack, anim2, {x:375, y:-75}, {ease:"custom", x:475, y:-75}, anim1);
