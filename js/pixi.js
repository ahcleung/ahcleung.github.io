...
function onHPDown(){
	...
	creatureInfo.info_item_text[1].text = itemList.data.skills[this.object.item[0]].name;
	creatureInfo.info_item_text[3].text = itemList.data.skills[this.object.item[0]].type;
	creatureInfo.info_item_text[5].text = itemList.data.skills[this.object.item[0]].category;
	creatureInfo.info_item_text[7].text = itemList.data.skills[this.object.item[0]].description;
