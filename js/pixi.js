...
function animationSequence(attacker, defender, animateBattle, animatePopup, animateStatus, animateHealth, animateMove){
	if(animateBattle){
		...
		defender.forEach(arrayCreature=>{
			...
			if(arrayCreature.newHP)		arrayCreature.action.sprite_d_dmg.visible = true;
			else  arrayCreature.action.sprite_d_miss.visible = true;
		...
		attacker.action.pReadyTween.eventCallback("onComplete", function(){
			...
			defender.forEach(arrayCreature=>{
				if(arrayCreature.newHP)		arrayCreature.action.dDmgTween.play(0);
				else  arrayCreature.action.dMissTween.play(0);
