...
//     		armatureHero.animation.play('idle');
	...
	pAtkTween.fromTo(sprite_p_fxBack, 0.5, {alpha:0}, {alpha:1}, anim1);
	pAtkTween.fromTo(sprite_p_fxBack, 0.5, {alpha:1}, {alpha:0}, anim1+anim2-0.25);
	pAtkTween.fromTo(sprite_p_attack, anim2, {x:375, y:-75}, {ease:"custom", x:750, y:-75}, anim1);
	pAtkTween.fromTo(sprite_p_fxTop, 0.5, {alpha:0}, {alpha:1}, anim1);
	pAtkTween.fromTo(sprite_p_fxTop, 0.5, {alpha:1}, {alpha:0}, anim1+anim2-0.33);
